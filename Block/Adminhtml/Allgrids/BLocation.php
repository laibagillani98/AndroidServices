...
class BLocation extends Extended
{
    protected $registry;
    ...
    {
        parent::_construct();
        $this->setId('blocationgrid');
        $this->setUseAjax(true);
        $this->setSaveParametersInSession(true);
    }
    protected function _prepareCollection()
    {
        $collection = $this->helper->OrdersCollection(0,"",0,1);
        $this->setCollection($collection);
        //  echo "<pre>";print_r($collection->getData());die("ccccc");
    ...
    {
        return $this->getUrl('*/*/ajaxgrids/type/blocation_orders', ['_current' => true]);
    }
}
