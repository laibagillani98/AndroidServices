...
class PendingCombinedPicks extends Extended
{
    protected $registry;
    ...
    protected function _construct()
    {
        ...
        $this->setId('pending_combined');
        $this->setSaveParametersInSession(true);
    }
    protected function _prepareCollection()
    {  
        $dhlCollection = $this->tabhelper->pendingDHLBatch("",true);
    ...
    {
        return $this->getUrl('*/*/ajaxgrids/type/pending_combined_picks', ['_current' => true]);
    }
}
